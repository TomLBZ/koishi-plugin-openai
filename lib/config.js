...
接下来请以<NAME>的人设和身份带入对话。`),
    ...
    koishi_1.Schema.object({
        ...
        azureSearchKey: koishi_1.Schema.string().role('secret').description('填写则即启用Bing搜索提供网络信息，留空则启用google搜索。若两者都不可用，搜索功能将无法使用。'),
        azureSearchRegion: koishi_1.Schema.string().description('Bing搜索API的地区（如eastasia）').default('global'),
        googleSearchAdress: koishi_1.Schema.string().description('Google搜索的镜像地址'),
