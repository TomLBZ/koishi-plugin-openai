...
exports.Config = koishi_1.Schema.object({
    ...
    temperature: koishi_1.Schema.percent().description("机器人的回复温度，越高越随机").default(0.9).required(),
    ...
    randomReplyFrequency: koishi_1.Schema.percent().description("机器人未被直接呼叫（未被@、未被直呼其名）时的随机回复概率").default(0.1).required(),
